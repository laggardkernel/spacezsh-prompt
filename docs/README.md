...
* [API](/docs/API.md)
  ...
  * [sz::section](/docs/API.md#spaceshipsection-color-prefix-content-suffix)
  * [sz::exists](/docs/API.md#spaceshipexists-command)
  * [sz::func_defined](/docs/API.md#spaceshipdefined-function)
  * [sz::is_git](/docs/API.md#spaceshipisgit)
  * [sz::is_hg](/docs/API.md#spaceshipishg)
  * [sz::deprecated](/docs/API.md#spaceshipdeprecated-option-message)
  * [sz::displaytime](/docs/API.md#spaceshipdisplaytime-seconds)
  * [sz::union](/docs/API.md#spaceshipunion-arr1-arr2-)
